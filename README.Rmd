...
```{r, fig.width=7, fig.height=7, fig.align='center', eval=FALSE, echo=FALSE}
...
text(-vowel_mds[,2],
     ...
     pos = 4)
```
```{r, echo=FALSE, fig.width=7, fig.height=7, fig.align='center', fig.cap = "Acoustic vowel plot"}
knitr::include_graphics("C:/Users/USER/Downloads/acoustic_vowel_plot.png")
```
