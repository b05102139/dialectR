...
.distance_matrix_internal <- function(dialect_data, funname, alignment_normalization = FALSE, delim = NULL) {
    .Call(`_dialectR_distance_matrix_internal`, dialect_data, funname, alignment_normalization, delim)
}
